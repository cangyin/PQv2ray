...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btnRefreshList = QtWidgets.QPushButton(self.groupBox_2)
        self.btnRefreshList.setEnabled(False)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.btnRefreshList.sizePolicy().hasHeightForWidth())
        self.btnRefreshList.setSizePolicy(sizePolicy)
        self.btnRefreshList.setText("")
        self.btnRefreshList.setObjectName("btnRefreshList")
        self.horizontalLayout_4.addWidget(self.btnRefreshList)
        ...
        self.btnQv2rayMultiPort.setMinimumSize(QtCore.QSize(0, 50))
        ...
        self.btnQv2rayBalancer.setMinimumSize(QtCore.QSize(0, 50))
