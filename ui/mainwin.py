...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btnBrowseQvFolder = QtWidgets.QPushButton(self.groupBox_2)
        self.btnBrowseQvFolder.setObjectName("btnBrowseQvFolder")
        self.gridLayout_2.addWidget(self.btnBrowseQvFolder, 0, 4, 1, 1)
        self.editQvFolder = QtWidgets.QLineEdit(self.groupBox_2)
        self.editQvFolder.setObjectName("editQvFolder")
        self.gridLayout_2.addWidget(self.editQvFolder, 0, 1, 1, 3)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "Qv2ray 目录"))
        self.label_2.setText(_translate("MainWindow", "节点组"))
        self.btnBrowseQvFolder.setText(_translate("MainWindow", "浏览"))
