...
class Ui_Settings(object):
    def setupUi(self, Settings):
        ...
        self.chkAutoStartQv2ray.setGeometry(QtCore.QRect(20, 200, 241, 19))
        ...
        self.layoutWidget1.setGeometry(QtCore.QRect(20, 100, 551, 54))
        ...
        self.editQvconfigFolder = QtWidgets.QLineEdit(self.layoutWidget1)
        self.editQvconfigFolder.setObjectName("editQvconfigFolder")
        self.horizontalLayout_7.addWidget(self.editQvconfigFolder)
        self.btnBrwsQvConfigFolder = QtWidgets.QPushButton(self.layoutWidget1)
        self.btnBrwsQvConfigFolder.setObjectName("btnBrwsQvConfigFolder")
        self.horizontalLayout_7.addWidget(self.btnBrwsQvConfigFolder)
        ...
        self.editSoResultPath = QtWidgets.QLineEdit(self.groupBox_6)
        self.editSoResultPath.setObjectName("editSoResultPath")
        self.horizontalLayout_5.addWidget(self.editSoResultPath)
        self.btnBrwsSoResultPath = QtWidgets.QPushButton(self.groupBox_6)
        self.btnBrwsSoResultPath.setObjectName("btnBrwsSoResultPath")
        self.horizontalLayout_5.addWidget(self.btnBrwsSoResultPath)
    ...
    def retranslateUi(self, Settings):
        ...
        self.label_17.setText(_translate("Settings", "Qv2ray 配置文件目录"))
        self.btnBrwsQvConfigFolder.setText(_translate("Settings", "浏览"))
        ...
        self.label_13.setText(_translate("Settings", "为 SwitchyOmega 生成的配置文件"))
        self.btnBrwsSoResultPath.setText(_translate("Settings", "浏览"))
